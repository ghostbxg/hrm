...
<center>
    <div class="container mt-2">
        <div class="sign-content  py-5 px-5 border" style=" background: #0c5460 ">
            <form action="/department/update" method="post" onSubmit="return check_admin(this);" >
                <div class="row">
                    <div class="col-sm-12">
                        <div class="signin-form">

                            <div class="form-group">
                                <input type="text" class="form-control text-light"  id="pname" name="pname" placeholder="请输入部门名称" required>
                                <input type="hidden" class="form-control text-light"  id="pid" name="pid">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control text-light" id="pcontent" name="pcontent" placeholder="请输入详细信息" required>
                            </div>
                        </div>
                    </div>
                </div>
