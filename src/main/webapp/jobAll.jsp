...
<div class="bg-info py-2 text-light">
    <i class="fa fa-arrow-circle-right pr-5" ></i>当前位置:职位管理 &nbsp;>&nbsp;职位查询
</div>
...
<div class="py-3">
    ...
    <div class="demoTable">
        ...
        <div class="layui-inline">
            <input class="form-control mr-sm-2" type="text" name="jname" id="jname" placeholder="请输入要查询的职位名称" aria-label="Search" size="28px">
        </div>
...
<script>
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                {type:'checkbox'}
                ,{field:'jname', width:200, title: '职业名称', sort: true}
                ,{field:'jcontent', width1:200, title: '详细信息'}
